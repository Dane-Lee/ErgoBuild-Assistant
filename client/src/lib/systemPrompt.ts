...
- safety_factor: the STRUCTURAL/mechanical design safety factor for the fixture (ratio of design strength to expected load) — typically 2.0–3.0 for ergonomic fixtures, higher for medical or high-risk. This is NOT a NIOSH Lifting Index or Recommended-Weight-Limit ratio; report any RWL, lifting index, or exposure-risk ratios in design_justification, never in safety_factor.
